...
const EventRegistration = () => {
  ...
  return (
    <>
      <div className="container mt-4">
        {/* Info note for parents about stored account information */}
        <div className="account-info-note">
          <div className="info-icon">
            <i className="fas fa-info-circle"></i>
          </div>
          <div className="info-content">
            <strong>Account Information Note:</strong> We have access to your account information including your email address and phone number. If needed, we will use this information to contact you about your child's registration or event updates.
          </div>
        </div>
